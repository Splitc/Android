...
import com.application.splitc.utils.GooglePlaceAutocompleteApi;
...
public class GooglePlaceAutocompleteAdapter extends BaseAdapter implements Filterable {
    ArrayList<GooglePlaceAutocompleteObject> resultList;
    Context mContext;
    LayoutInflater inflater;
    String typeParam;
    GooglePlaceAutocompleteApi mPlaceAPI;
    ArrayList<GooglePlaceAutocompleteObject> autocompleteStaticData = null;
    ...
    @Override
    public GooglePlaceAutocompleteObject getItem(int position) {
